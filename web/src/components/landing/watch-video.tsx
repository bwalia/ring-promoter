    ...
    <section id="watch" className="scroll-mt-20 border-b border-white/[0.07]">
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
        <Reveal variant="mask" className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-balance text-2xl font-semibold tracking-tight text-neutral-50 sm:text-3xl">
            See Ring Promoter in action.
          </h2>
        </Reveal>
        <Reveal delay={0.1} className="mt-8">
          <div className="overflow-hidden rounded-xl border border-white/[0.07] bg-[#0b0b0c] shadow-[0_0_0_1px_rgba(34,197,94,0.06)]">
