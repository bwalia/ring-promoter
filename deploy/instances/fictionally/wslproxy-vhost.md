...
1. **DNS** — a Cloudflare **CNAME** `ring-promoter.fictionally.org → lon1.pop0.uk`.
   ...
   ```
   Type: CNAME   Name: ring-promoter   Target: lon1.pop0.uk   Proxied: off
   ```
...
```bash
dig +short ring-promoter.fictionally.org        # -> lon1.pop0.uk.
